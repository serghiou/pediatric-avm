...
output:
  rmdformats::readthedown:
    ...
    code_folding: show # [hide, show] (comment out to not give option)
  pdf_document:
    highlight: tango
    df_print: kable
...
if (str_detect(params$TITLE, "Hemorrhage")) {
  EXPOSURES_BINARY <- EXPOSURES_BINARY[!EXPOSURES_BINARY == "has_hemorrhage"]
}
